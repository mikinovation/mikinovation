...
<template>
  <div class="github-repository-table">
    ...
    <table v-else class="repository-table">
      ...
      <tbody>
        <tr v-for="repo in repositories" :key="repo.id" class="repository-row">
          <td class="repository-name">
            <a :href="repo.html_url" target="_blank" rel="noopener noreferrer">
              {{ repo.name }}
            </a>
            <span v-if="repo.fork" class="fork-badge">Fork</span>
            <span v-if="repo.archived" class="archived-badge">Archived</span>
          </td>
    ...
    <div v-if="repositories.length > 0" class="pagination-controls">
      <button 
